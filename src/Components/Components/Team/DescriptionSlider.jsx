...
const DescriptionSlider = () => {
  ...
  return (
    <div className='flex h-[35rem] w-[78rem] bg-white bg-opacity-20'>
      ...
      <div className={`${descriptionIndex!=0 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
ourcash balance sheets and overall finances, and simply reinvesting every single penny we make.	"/>
      ...
      <div className={`${descriptionIndex!=1 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=2 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=3 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
“Vision without action is merely a dream. Action without vision just passes the time. Vision with action can change the world”"/>
      ...
      <div className={`${descriptionIndex!=4 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=5 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=6 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=7 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=8 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=9 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=10 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=11 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=12 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=13 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=14 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=15 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=16 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=17 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
      <Description namembr="DASCALU IOANA" descriptiontxt="		My name is Ioana, I'm 20 years old, I'm sociable, artistic and quite fixated. I have been a copywriter and content creator for about two years. It all started from a game at the age of 17, and two years ago I started everything seriously. I like to get 100% involved in every project. I like everything to be put together exactly and in great detail."/>
</div>
<div className={`${descriptionIndex!=18 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=19 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=20 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=21 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=22 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=23 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
...
<div className={`${descriptionIndex!=24 && "hidden " } flex flex-col justify-center items-center px-[5rem]`}>
