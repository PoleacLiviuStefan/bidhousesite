  ...
  return (
    <div className="relative bg-black w-full h-[290rem]">
      ...
      <div className="absolute top-[430px] w-full h-full flex flex-col items-center">
        ...
        <div className="relative text-opacity-70 font-[200] text-white leading-[28px] w-[70rem] top-12 left-0 text-[20px]">
        ...
        <div className="relative flex top-[10rem] w-[1137px] justify-between">
          <CardInfo
            description={
              <p className="relative top-16 text-white w-[463px] h-[106px]  font-[200] text-[16px] leading-[17px]">
                <span className=" opacity-70">
                  We want to bring Solana Chain in the real world by buying
                  apartments in Bucharest - Romania , rent them and get profits
                  for our community.
                </span>
                <br />
            ...
            description={
              <p className="relative top-16 text-white w-[463px] h-[106px]  font-[200] text-[16px] leading-[17px]">
                <span className=" opacity-70">
                  ...
                  addition to that we have more than 10 people ready to help us
                  with minor tasks as moderate Discord, posting on Twitter, etc.
                </span>
                <br />
                <span className="opacity-100 text-white">
          ...
          <CardInfo
            description={
              <p className="relative top-16 text-white w-[463px] h-[106px]  font-[200] text-[16px] leading-[17px]">
                ...
                <span className=" opacity-70">
                  In the real world all begins in Bucharest Romania and we will
                  expand our vision and our assets as a community all over the
                  world.
                </span>
                <br />
              </p>
