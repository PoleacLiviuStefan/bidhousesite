...
const Hero = () => {
  ...
  return (
    <div name="hero" className=" w-screen h-screen  bg-black ">
      <div className="bg-[url('/public/hero.webp')] flex  justify-center h-[120%] bg-cover w-full">
        <div className="relative ml-10  top-[15rem] xl:top-[22%]  flex w-[1351px] h-[451px] ">
          <div className="absolute top-[-150px] z-0 right-[-28rem]  w-[700px] h-[580px] bg-[url('/public/glowarea.png')] bg-cover" />
          <Fade left delay={500}>
          ...
          <Fade bottom delay={1000}> <button className={styles.accesbtn}><a href={downloadpdf}  download>Whitepaper</a></button></Fade>
          <Link
          activeClass="active"
          to="Contact"
          spy={true}
          ...
          delay={200}
        >
         <Fade bottom delay={1000}>  <button className={styles.contactbtn}>Contact Us</button></Fade>
        </Link>
        ...
        <div  className={`fixed flex  justify-center items-center ${!popupVideo && "hidden"} top-0 left-0 z-40 bg-black bg-opacity-70 w-screen h-screen `}>
        <div onClick={handlePlayVideo} className="fixed top-0 left-0 w-screen h-screen z-20"></div>
        <div className='fixed top-0 flex h-[900px] w-[900px]  justify-center items-center z-30'>
...
<div  className={`absolute cursor-pointer z-50 top-[-5rem] left-[-3rem] text-white w-full text-[30px]  `}></div>
        ...
        <div className="absolute flex z-20   items-center flex-col  bottom-[-10rem]  xl:bottom-[-5rem]">
