...
const RarityCard = ({keyimg,title,color,benefit}) => {
  ...
  return (
    <div onMouseLeave={handleExpandBack} onMouseEnter={handleExpand} className={`relative ml-6 mt-[8rem] xl:mt-0 rounded-[20px] backdrop-blur-[8px] flex flex items-center justify-center w-[180px] h-[424px] `}>
