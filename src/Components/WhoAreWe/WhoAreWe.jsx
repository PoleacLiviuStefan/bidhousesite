...
const WhoAreWe = () => {
  return (
    ...
    <div name="WhoAreWe" className=" bg-black h-[70rem] w-full">
      <div className="absolute rounded-[20px] z-40 bg-[url('/public/phase1.jpeg')]   bg-cover w-[300px] h-[306px] xl:w-[600px] xl:h-[610px] 2xl:w-[721px] 2xl:h-[733px]" />
      <div className="absolute bg-[url('/public/bg2.png')]  top-[80px] w-[95%] h-[1000px] xl:h-[934px]  left-0 bg-cover">
        ...
        <div className="absolute  z-40 right-[25px] xl:right-[40px] top-[300px] xl:top-[130px] ">
