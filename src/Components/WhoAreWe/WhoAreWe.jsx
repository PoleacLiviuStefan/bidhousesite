...
const WhoAreWe = () => {
  return (
    <div className=" bg-black h-[70rem] w-full">
      <div className="absolute  z-50 bg-[url('/public/leftside.png')]  bg-cover w-[300px] h-[306px] xl:w-[721px] xl:h-[733px]" />
      <div className="absolute bg-[url('/public/bg2.png')]  top-[80px] w-[95%] h-[734px]  left-0 bg-cover">
        ...
        <div className="absolute z-50 right-[55px] xl:right-[40px] top-[350px] xl:top-[200px] ">
