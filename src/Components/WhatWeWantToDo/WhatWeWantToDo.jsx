...
const WhatWeWantToDo = () => {
  return (
    <div className=" bg-black  rounded-[20px] h-[70rem] w-full">
      <div className="absolute  right-0   z-50 bg-[url('/public/weareright.png')] bg-cover w-[300px] h-[306px] xl:w-[721px] xl:h-[733px]" />
      <div className="absolute bg-[url('/public/bg.png')] top-[80px] w-[95%] h-[734px] right-0 bg-cover">
        ...
        <div className="absolute z-50 left-[40px] top-[250px] xl:top-[110px] ">
