...
const WhatWeWantToDo = () => {
  return (
    <div className="   rounded-[20px] h-[70rem] w-full">
      ...
      <div className="absolute 2xl:right-[2.5rem] xl:right-[.5rem] right-[1.5rem] xl:top-[25rem] top-[4rem] z-40    z-40 bg-[url('/public/logotxt.png')] bg-cover w-[315px] h-[130px] xl:w-[710px] xl:h-[290px]" />
