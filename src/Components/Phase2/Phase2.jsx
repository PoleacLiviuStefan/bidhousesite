...
const Phase2 = () => {
  return (
    <div className=" bg-black  rounded-[20px] h-[70rem] w-full">
      <Fade right><div className="absolute top-[2rem] xl:top-[15rem]  right-0   z-40 " >
      ...
      <div className="absolute bg-[url('/public/bg.png')] top-[80px] w-[95%] h-[1150px] xl:h-[934px] right-0 bg-cover">
        ...
        <div className="absolute z-40 left-[22px] xl:left-[40px] top-[250px] xl:top-[110px] ">
         <Fade top> <h2 className="font-[600]   text-[35px] leading-[40px]  xl:leading-[72px] 2xl:xl:leading-[112px] xl:text-[52px] 2xl:text-[76px] text-white  bg-clip-text bg-gradient-to-r from-[#9945FF] to-[#17DD8A] ">
