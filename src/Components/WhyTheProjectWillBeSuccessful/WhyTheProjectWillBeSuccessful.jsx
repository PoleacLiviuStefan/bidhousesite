...
const WhyTheProjectWillBeSuccessful = () => {
  return (
    <div className=" bg-black h-[70rem] w-full">
      ...
      <div className="absolute bg-[url('/public/whatwewanttodobg.png')] right-0 top-[40px] w-[90%] h-[676px]  bg-cover">
        ...
        <div className="absolute z-50 left-[40px] top-[60px] ">
          <div className="relative  bg-[url('/public/whytheprojectwillbesuccessfultitle.png')] bg-cover  w-[786px] h-[296px]" />
